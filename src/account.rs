...
pub struct Account {
    ...
    pub frozen_commission: f32,
    pub frozen_premium: f32,
    pub available: f64,
    pub risk_ratio: f32,
}
...
pub struct Position {
    ...
    pub exchange_id: String,
    pub instrument_id: String,
    pub volume_long_today: i32,
    pub volume_long_his: i32,
    pub volume_long: i32,
    pub volume_long_frozen_today: i32,
    pub volume_long_frozen_his: i32,
    pub volume_long_frozen: i32,
    pub volume_short_today: i32,
    pub volume_short_his: i32,
    pub volume_short: i32,
    pub volume_short_frozen_today: i32,
    pub volume_short_frozen_his: i32,
    pub volume_short_frozen: i32,
    pub volume_long_yd: i32,
    pub volume_short_yd: i32,
    pub pos_long_his: i32,
    pub pos_long_today: i32,
    pub pos_short_his: i32,
    pub pos_short_today: i32,
